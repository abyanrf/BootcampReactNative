...
console.log(`${word} ${second} ${third} ${fourth} ${fifth} ${sixt} ${seventh}`);
...
var fifithWordLength = fifthWord3.length;
...
console.log("Fifth Word: " + fifthWord3 + ", with length: " + fifithWordLength);
